...
button.on("click", function() {
    ...
    d3.select(".east-img").html("<img src='../static/images/East_Region/east2_Arcadia.JPG' alt='Arcadia'>");     
  });

  // need to clear html for next button click